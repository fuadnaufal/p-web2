...
<head>
    ...
    <style>
        ...
        .info {backround: #e8f5e9; border-left: 4px solid #27ae60; padding: 12px; margin: 10px 0;}
        .server {bacround: #fff3cd; border-left: 4px solid #ffc107; padding: 12px; margin: 10px 0;}
        .library-info {bacround: #fff3cd; border-left: 4px solid #e90808; padding: 12px; margin: 10px 0;}
    </style>
</head>
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Fuad Naufal Ihsan"; ?></p>
        ...
        $alamat_perpus  = "JL. Teratai No. 07, Kota kajen";
        $telepon_perpus = "+62 847478399";
        $jam_buka       = "08:00";
        $jam_tutup      = "23:00";
        $hari_libur     = "Sabtu – Minggu";
        $persen_tersedia = round(($buku_tersedia / $total_buku) * 100, 1);  // Perhitungan persentase baru
        ?>
